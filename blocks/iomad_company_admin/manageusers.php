...
if (iomad::has_capability('block/iomad_company_admin:company_add', $systemcontext)) {
    $mform = new iomad_manageuser_filter_form(null, array('companyid' => $companyid, 'useshowall' => true, 'addusertype' => true));
} else {
    $mform = new iomad_manageuser_filter_form(null, array('companyid' => $companyid, 'addusertype' => true));
}
...
$table = new \block_iomad_company_admin\tables\manageusers_table('block_iomad_company_admin_manageusers_table');
