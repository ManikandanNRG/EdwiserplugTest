...
$string['licensetoomanyusers'] = '<span class="alert alert-warning licensetoomanyusers">You have tried to allocate more than the available number of licenses.</span>';
...
$string['manage_user_title'] = 'Admin Panel';
